...
**Page history** on every docs page follows [`_shared/style-guide.html`](../front/_shared/style-guide.html#page-history) (table: Date, Change, Author).
...
4. **UI script** — [`services/frontend/portal/assets/docs-internal-meta.js`](../../../frontend/portal/assets/docs-internal-meta.js) (loaded after `docs-portal-data.js`) renders:
...
On any HTML page under `services/portal/` (except `services/frontend/portal/assets/`), set on `<body>`:

```html
data-maintainer-ids="<person-id>[,<another-id>...]"
```

Use the same `data-person-id` as on the maintainer’s profile. Include [`docs-portal-data.js`](../../../frontend/portal/assets/docs-portal-data.js) and [`docs-internal-meta.js`](../../../frontend/portal/assets/docs-internal-meta.js) if you want the **Page editors** block (`#docs-page-meta-mount`).
